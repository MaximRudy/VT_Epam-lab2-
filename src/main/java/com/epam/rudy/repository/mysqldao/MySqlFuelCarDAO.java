...
public class MySqlFuelCarDAO extends MySqlDAO<FuelCar> {

	public MySqlFuelCarDAO(String url, String login, String password) {
	...
	@Override
	void fillPreparedStatement(PreparedStatement preparedStatement, FuelCar object) throws SQLException {
	...
	@Override
	FuelCar toObject(ResultSet resultSet) throws SQLException {
		return new FuelCar(
