...
public class MySqlBusDAO extends MySqlDAO<Bus> {

	public MySqlBusDAO(String url, String login, String password) {
	...
	@Override
	void fillPreparedStatement(PreparedStatement preparedStatement, Bus object) throws SQLException {
		...
		preparedStatement.setInt(8, object.getNumberOfAxles());
	}

	@Override
	Bus toObject(ResultSet resultSet) throws SQLException {
		return new Bus(
