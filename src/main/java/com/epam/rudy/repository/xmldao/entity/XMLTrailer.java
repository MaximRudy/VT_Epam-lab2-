...
public class XMLTrailer {
	...
	public XMLTrailer(String id, VehicleType vehicleType, String model, int yearOfManufacture, boolean isIndependentVehicle) {
		this.id = id;
	...
	public void setIsIndependentVehicle(boolean independentVehicle) {
		isIndependentVehicle = independentVehicle;
	}
}
